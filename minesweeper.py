...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        for i in range(cell[0] - 1, cell[0] + 2):
            for j in range(cell[1] - 1, cell[1] + 2):
                ...
                if 0 <= i < self.height and 0 <= j < self.width and (i,j) not in self.moves_made:
                    neigbour_list.append((i,j))

        self.knowledge.append(Sentence(neigbour_list,count))
        ...
        # updating the new mines and safes
    ...
    def make_random_move(self):
        ...
        """
        #raise NotImplementedError
        while len(self.moves_made)+len(self.mines)!=self.height*self.width:
